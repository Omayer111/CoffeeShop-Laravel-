            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/#section_3">Our Menu</a>
                        </li>
                    ...
                    <div class="ms-lg-3">
                        <a class="btn custom-btn custom-border-btn" href="{{ route('reservation') }}">
                            Reservation
                        ...
                        <div class="booking-form-wrap">
                            <div class="row">
                                <div class="col-lg-7 col-12 p-0">
                                    <form class="custom-form booking-form" action="/reservation" method="post"
                                        role="form">
                                        @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    <input type="tel" class="form-control" name="phone"
                                                        placeholder="Phone: 085 456 7890" required="">
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    <input type="number" name="number" id="booking-form-number"
                                                        class="form-control" placeholder="Number of People"
                                                        required="">

                                                    <textarea name="message" rows="3" class="form-control" id="booking-form-message"
